/* eslint-disable */
/* Remove this file after https://github.com/effector/effector/issues/1130 is fixed */
import { ComputedRef, Ref, UnwrapRef } from 'vue';
import { Domain, Store, Event, Effect, Scope } from 'effector';

declare module 'effector-vue/composition' {
  type GateConfig<T> = {
    name?: string;
    defaultState?: T;
    domain?: Domain;
  ...
  export function useStore<T>(store: Store<T>): Readonly<Ref<T>>;
  ...
  export function useUnit<
    Shape extends Record<
      string,
      Event<any> | Effect<any, any, any> | Store<any>
    >,
  >(
